...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-05-2024 a las 21:19:37
...
INSERT INTO `ciudad` (`id_ciudad`, `ciudad`, `idf_provincia`, `codigoPostal`) VALUES
(1, 'Pergamin', 0, '2000');
...
INSERT INTO `domicilio` (`id_domicilio`, `idf_ciudad`, `calle`, `numero`, `piso`, `depto`) VALUES
(1, 0, 'Pedro del Castillo', '3411', '12', 'A');
...
INSERT INTO `persona` (`id_persona`, `apellidos`, `nombres`) VALUES
(1, 'Perez', 'Juan');
...
INSERT INTO `provincia` (`id_provincia`, `provincia`, `idf_pais`) VALUES
(1, 'Buenos Aires', 0);
...
INSERT INTO `tipodoc` (`id_tipoDoc`, `tipoDoc`) VALUES
(1, 'DNI');
...
ALTER TABLE `datoscontacto`
  ...
  ADD KEY `idf_personas` (`idf_personas`);
...
--
-- AUTO_INCREMENT de la tabla `contato`
--
ALTER TABLE `contato`
...
--
-- Filtros para la tabla `contato`
--
ALTER TABLE `contato`
  ADD CONSTRAINT `contato_ibfk_1` FOREIGN KEY (`idf_cotizacion`) REFERENCES `cotizacion` (`id_cotizacion`),
  ADD CONSTRAINT `contato_ibfk_2` FOREIGN KEY (`idf_precontrato`) REFERENCES `precontrato` (`id_precontrato`),
  ADD CONSTRAINT `contato_ibfk_3` FOREIGN KEY (`idf_firmantecontrato`) REFERENCES `colaborador` (`id_colaborador`),
  ADD CONSTRAINT `contato_ibfk_4` FOREIGN KEY (`idf_contratomodelo`) REFERENCES `contratomodelo` (`id_modelo`),
  ADD CONSTRAINT `contato_ibfk_5` FOREIGN KEY (`idf_estadogestion`) REFERENCES `estadogestion` (`id_estadogestion`);
...
--
ALTER TABLE `datoscontacto`
  ADD CONSTRAINT `datoscontacto_ibfk_1` FOREIGN KEY (`id_datosContacto`) REFERENCES `persona` (`id_persona`),
